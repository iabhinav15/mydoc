...
export const Ruler = () => {
  ...
  return (
    <div
      ...
      className="h-6 w-204 mx-auto border-b flex items-end relative select-none print:hidden"
    >
      <div className="w-full h-full relative" id="ruler-container">
        ...
        <div className="absolute inset-x-0 bottom-0 h-full">
          <div className="relative h-full w-204">
            {markers.map((marker) => {
              const position = (marker * PAGE_WIDTH) / 82; //The width of the sheet is PAGE_WIDTHpx == w-204
              return (
                <div
                  key={marker}
